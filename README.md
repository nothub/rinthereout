...
- [Minecraft Comes Alive Reborn](https://modrinth.com/mod/minecraft-comes-alive-reborn)
...
The Modpack also contains some [Vanilla Tweaks](https://vanillatweaks.net/):

- [Resource Packs](https://vanillatweaks.net/share#zZlE69)
    - Different Stems
    - Black Nether Bricks
- [Data Packs](https://vanillatweaks.net/share#pAYfAw)
    - Classic Fishing Loot
    - Player Head Drops
    - Bat Membranes
    - Anti Enderman Grief
    - More Mob Heads
- [Crafting Tweaks](https://vanillatweaks.net/share#3nV9x2)
